...
clientRouter.get("/create-box/:page/:roomId", async (req, res) => {
    res.render("object-creation/create-box", {roomId: req.params.roomId, page: req.params.page});
});

clientRouter.get("/create-item/:roomId/:containerName/:containerId", async (req, res) => {
    res.render("object-creation/create-item", {containerId: req.params.containerId, containerName: req.params.containerName, roomId:req.params.roomId});
});
